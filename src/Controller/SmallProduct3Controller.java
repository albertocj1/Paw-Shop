...
public class SmallProduct3Controller {
    
    @FXML
    Button SmallPetCategory;
    ...
    private final Image[] pictures = { 
        new Image("Images/S3.1PRODUCTS.png"),
        new Image("Images/S3.2PRODUCTS.png"),
        new Image("Images/S3.3PRODUCTS.png")
    };
