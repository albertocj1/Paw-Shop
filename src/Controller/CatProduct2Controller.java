...
public class CatProduct2Controller{
    ...
    @FXML
    Label namec2, namec22, namec222, pricec2;
    ...
    private final Image[] pictures = { 
        new Image("Images/C2. PRODUCT.png"),
        new Image("Images/C2.1 PRODUCT.png"),
        new Image("Images/C2.2 PRODUCT.png")
    };
